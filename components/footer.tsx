...
export default function Footer() {
  ...
  return (
    <footer id="contact" className="section section--gray footer">
      <div className="section-container">
        <div className="footer-content">
          <div className="footer-info">
            <h2 className="footer-title">{siteConfig.title}</h2>
        ...
        <div className="footer-bottom">
          <p className="footer-copyright">&copy; 2024 {siteConfig.title}. All rights reserved.</p>
        </div>
      </div>
    </footer>
  )
